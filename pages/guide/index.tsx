...
export const steps = [
  {
    step: "guide:steps.selectBank.step",
    title: "guide:steps.selectBank.title",
  },
  {
    step: "guide:steps.downloadBudget.step",
    title: "guide:steps.downloadBudget.title",
  },
  {
    step: "guide:steps.uploadBudget.step",
    title: "guide:steps.uploadBudget.title",
  },
];
    ...
    <AppGuideCardComponent steps={steps} currentStep={0}>
      ...
      <CardActions className="justify-center">
        ...
        <div className="absolute bottom-1 left-1">
          <Link href="/kalkulator">{t("guide:noBank")}</Link>
        </div>
      </CardActions>
